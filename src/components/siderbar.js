...
class Siderbar extends Component {
  ...
  render() {
    return (
      <Panel className="sider">
        <Panel className="panel">
          <Button bsStyle="primary" onClick={() => browserHistory.push('/topics/new')}>发布新话题</Button>
        </Panel>
        <Panel header="小贴士">
          本站是开源的哦，访问 http://gethomeland.com 获得更多信息
        </Panel>
        <Panel header="推荐Ruby资源">
